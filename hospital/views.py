...
#for showing signup/login button for admin(by smita)
...
#for showing signup/login button for doctor(by smita)
...
#for showing signup/login button for patient(by smita)
...
#-----------for checking user is doctor , patient or admin(by smita)
def is_admin(user):
